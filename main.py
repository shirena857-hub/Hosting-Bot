...
# Project Limits
FREE_TIER_SLOTS = 1
PREMIUM_TIER_SLOTS = 10      # মোট কতগুলো প্রিমিয়াম স্লট বিক্রি করা যাবে (পেমেন্টের জন্য)
SLOT_PRICE_STARS = 5
...
class AdminFSM(StatesGroup):
    ...
    awaiting_remove_premium_id = State()  # নতুন স্টেট
...
def get_admin_panel_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        # প্রিমিয়াম বাটন (Add, Remove, List)
        [
